...
:: Liberar puertos críticos antes de arrancar
echo [%date% %time%] [AURORA] Liberando puertos 3000 y 24678...
powershell -ExecutionPolicy Bypass -File "scripts/free-port.ps1" -Port 3000
powershell -ExecutionPolicy Bypass -File "scripts/free-port.ps1" -Port 24678
