...
export default defineSchema({
  ...
  // Agents learn from engagement, remember what works, evolve over time
  // ============================================================

  agentMemories: defineTable({
    agentId: v.string(),
    agentName: v.string(),
    contentHistory: v.array(v.object({
    ...
    topPerformingTypes: v.array(v.object({
      contentType: v.string(),
      category: v.string(),
      avgEngagement: v.number(),
      postCount: v.number(),
    })),
    lowPerformingTypes: v.array(v.object({
      contentType: v.string(),
      category: v.string(),
      avgEngagement: v.number(),
      postCount: v.number(),
    ...
    worstPostingTimes: v.array(v.number()),
    voiceStyle: v.object({
      emojiUsage: v.number(),
      postLength: v.number(),
      formality: v.number(),
      questionFrequency: v.number(),
      personalStoryFrequency: v.number(),
    }),
    learnedTopics: v.array(v.string()),
    avoidedTopics: v.array(v.string()),
    signaturePhrases: v.array(v.string()),
    maturityLevel: v.number(),
    totalPosts: v.number(),
    totalEngagement: v.number(),
    avgEngagementPerPost: v.number(),
    lastLearnedAt: v.number(),
    learningIterations: v.number(),
    createdAt: v.number(),
    updatedAt: v.number(),
  ...
  agentActivityLog: defineTable({
    ...
    repliesMade: v.number(),
    totalEngagementReceived: v.number(),
    avgEngagementPerPost: v.number(),
    topPostType: v.optional(v.string()),
    topPostCategory: v.optional(v.string()),
    lessons: v.array(v.string()),
    createdAt: v.number(),
  }).index("by_agent_date", ["agentId", "date"]),

  marketKnowledge: defineTable({
    topic: v.string(),
    sentiment: v.string(),
    confidence: v.number(),
    source: v.string(),
